...
<style type="text/css">
body {
background-image:url("fantastic-pest.png");
...
<p><a href="custprofile.php"><input type="button" value="SignUp"></a></p>
<p><input type="button" value="Forget Password" onclick="forgetpassword()"></p>
</fieldset>
...
<?php
                ...
                $qry="select * from customer where emailid='$username' and password='$password'";
                ...
                if( $a==null){
                                ...
                                header("location:customer_home.php?cname=$a[1]");}
...
window.location="forgetpassword.php?username="+a;
}
</script>
