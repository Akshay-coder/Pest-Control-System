...
<div class="back">
        <center>
                ...
                <a href="custhome1.php?cname=<?php echo$cname?>" style="float:right;color:black;"><img src=homeimg.png height=35 width=35></img></a>

        </center>
</div>
</body>

<title>EDIT PROFILE SCREEN</title>
...
<form action="custprofileprocess.php" method="POST">

<center>
<?php
$cname=$_GET['cname'];
$con=pg_connect("host=localhost dbname=nursary user=postgres");
...
<td><input type="text" name="cadd"  value='<?php echo $cadd;?>'></td>
</tr>
...
<tr>
<td><input type="hidden" name="emailid" value='<?php echo $emailid;?>'></td>
</tr>
